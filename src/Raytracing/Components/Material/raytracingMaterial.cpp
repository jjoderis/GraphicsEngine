...
void Engine::RaytracingMaterial::setColor(const Math::Vector4 &color) { m_color = color; }
void Engine::RaytracingMaterial::setColor(float r, float g, float b, float a)
{
    m_color = Engine::Math::Vector4{r, g, b, a};
}
Engine::Math::Vector4 &Engine::RaytracingMaterial::getColor() { return m_color; }
