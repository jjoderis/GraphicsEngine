...
namespace Engine {
    ...
    private:
        ...
        // the implementation of the callback system is based on this blog post: http://nercury.github.io/c++/interesting/2016/02/22/weak_ptr-and-event-cleanup.html
        ...
        void invokeAndCleanup(std::list<std::weak_ptr<component_table_callback>> &cbs, unsigned int entityId, std::weak_ptr<ComponentType> component) {
    ...
    public: 
        ...
        void updated(unsigned int entityId) {
            ...
            if (componentIndex > -1) {
                invokeAndCleanup(m_updateCallbacks[componentIndex], entityId, m_components[componentIndex]);
            }
        }
    };
}
