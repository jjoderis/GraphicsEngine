...
void Engine::TransformComponent::rotate(const Math::Vector3 &rotation) { m_rotation += rotation; }
void Engine::TransformComponent::setRotation(const Math::Vector3 &rotation) { m_rotation = rotation; }
Engine::Math::Vector3 &Engine::TransformComponent::getRotation() { return m_rotation; }
...
void Engine::TransformComponent::update()
{
    ...
    m_modelMatrixInverse =
        Math::getScaling(1 / m_scaling) * Math::getRotation(-m_rotation) * Math::getTranslation(-m_translation);
