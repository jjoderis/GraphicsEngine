...
{
    if (std::shared_ptr<Engine::GeometryComponent> geometry =
            registry.getComponent<Engine::GeometryComponent>(selectedEntity))
    {
        createComponentNodeOutline<Engine::GeometryComponent>(
            "Geometry",
            registry,
            geometry.get(),
            [&]()
