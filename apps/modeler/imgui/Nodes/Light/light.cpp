...
void drawDirectionalLightNode(Engine::Registry &registry)
{
    if (std::shared_ptr<Engine::DirectionalLightComponent> light =
            registry.getComponent<Engine::DirectionalLightComponent>(selectedEntity))
    {
        UICreation::createComponentNodeOutline<Engine::DirectionalLightComponent>(
            "Directional Light",
            registry,
            light.get(),
            [&]()
...
{
    if (std::shared_ptr<Engine::PointLightComponent> light =
            registry.getComponent<Engine::PointLightComponent>(selectedEntity))
    {
        UICreation::createComponentNodeOutline<Engine::PointLightComponent>(
            "Point Light",
            registry,
            light.get(),
            [&]()
...
{
    if (std::shared_ptr<Engine::SpotLightComponent> light =
            registry.getComponent<Engine::SpotLightComponent>(selectedEntity))
    {
        UICreation::createComponentNodeOutline<Engine::SpotLightComponent>(
            "Spot Light",
            registry,
            light.get(),
            [&]()
